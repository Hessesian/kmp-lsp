...
pub(crate) struct Indexer {
    ...
    /// Lazy-loading sources JAR cache.
    /// Stores parsed symbols from sources JARs, loaded into the main index on demand.
    pub(crate) sources_cache: std::sync::Mutex<crate::indexer::sources_cache::SourcesCache>,
}
...
impl Indexer {
    ...
    pub(crate) fn new() -> Self {
        ...
        Self {
            ...
            sources_cache: std::sync::Mutex::new(
                crate::indexer::sources_cache::SourcesCache::new(
                    crate::indexer::sources_cache::load_cache(),
                ),
            ),
        }
    }

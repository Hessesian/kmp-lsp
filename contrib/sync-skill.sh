#!/usr/bin/env bash
# sync-skill.sh — install the kmp-lsp Copilot skill from the repo
#
# Usage: ./contrib/sync-skill.sh
#
# Copies contrib/copilot-extension/extension.mjs to
#   ~/.copilot/extensions/kmp-lsp/extension.mjs
...
DEST="$HOME/.copilot/extensions/kmp-lsp/extension.mjs"

...
fn a_default_import_packaged_extension_return_type_is_inferable_without_an_import() {
    ...
    assert_eq!(
        ...
        // `extract_return_type_from_detail` intentionally strips the trailing
        // `?` (see `return_type_nullable_stripped` in this same file) — `"T"`,
        // not `"T?"`, is this helper's real contract.
        Some("T".to_owned()),

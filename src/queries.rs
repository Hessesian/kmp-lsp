...
pub(crate) const KIND_AS_EXPR: &str = "as_expression";
...
pub(crate) const KIND_ADDITIVE_EXPR: &str = "additive_expression";
pub(crate) const KIND_MULTIPLICATIVE_EXPR: &str = "multiplicative_expression";
pub(crate) const KIND_PARENTHESIZED_EXPR: &str = "parenthesized_expression";
